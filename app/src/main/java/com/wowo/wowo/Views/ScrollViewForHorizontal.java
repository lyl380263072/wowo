 ...
 * ScrollView的滚动Y值进行监听
 */
public class ScrollViewForHorizontal extends ScrollView {
    ...
    public ScrollViewForHorizontal(Context context) {
        super(context);
    }

    public ScrollViewForHorizontal(Context context, AttributeSet attrs) {
        super(context, attrs);
        mGestureDetector = new GestureDetector(new YScrollDetector());
        setFadingEdgeLength(0);
    }

    public ScrollViewForHorizontal(Context context, AttributeSet attrs, int defStyleAttr) {
