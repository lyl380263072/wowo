package com.wowo.wowo.Views.MarqueeView;
...
public class MarqueeView extends ViewFlipper {
    ...
    @AnimRes
    private int inAnimResId = R.anim.in_animation;
    @AnimRes
    private int outAnimResId = R.anim.out_animation;
        ...
        if (hasSetDirection) {
            switch (direction) {
                case DIRECTION_BOTTOM_TO_TOP:
                    inAnimResId = R.anim.in_animation;
                    outAnimResId = R.anim.out_animation;
                    break;
...
//                    outAnimResId = R.anim.anim_right_out;
    ...
    private void setTextColor(TextView text) {
        ...
        ForegroundColorSpan redSpan = new ForegroundColorSpan(GetResourcesUtil.getColor(mContext, R.color.btn_green));
        builder.setSpan(redSpan, 0, str.indexOf("*",str.indexOf("*") + 1)+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
