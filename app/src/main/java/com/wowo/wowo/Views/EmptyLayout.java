...
public class EmptyLayout extends LinearLayout {
    ...
    private TextView mEmptyTtileView;
    ...
    private int mErrorDrawable = R.mipmap.ic_error;
    private int mEmptyDrawable = R.mipmap.profile_img_fb_dis;
    private int mLoadingDrawable = R.mipmap.ic_loading;

    private String mErrorMessage = "哎呀！发生了一些错误";
    private String mEmptyMessage = "啥也没有";
    private String mEmptyTitle = "发布技能您会挣到更多的钱";
...
//        getChildViews();
    ...
    /**
     * Gets the loading layout_wx_pay_entry
     * @return the loading layout_wx_pay_entry
     */
    ...
    /**
     * Sets loading layout_wx_pay_entry
     * @param loadingView
     */
    ...
    /**
     * Sets loading layout_wx_pay_entry resource
     * @param res
     */
    ...
    /**
     * Gets the empty layout_wx_pay_entry
     * @return the empty layout_wx_pay_entry
     */
    ...
    /**
     * Sets empty layout_wx_pay_entry
     * @param emptyView
     */
    ...
    /**
     * Sets empty layout_wx_pay_entry resource
     * @param res
     */
    ...
    /**
     * Gets the error layout_wx_pay_entry
     * @return the error layout_wx_pay_entry
     */
    ...
    /**
     * Sets error layout_wx_pay_entry
     * @param errorView
     */
    ...
    /**
     * Sets error layout_wx_pay_entry resource
     * @param res
     */
     ...
     * @param emptyMessage the message
     */
    public void setEmptyMessage(String emptyMessage,String title) {
        this.mEmptyMessage = emptyMessage;
...
//        setEmptyMessage(text);
     ...
     * @param text
     */
    public void showEmpty(int resId,String text,String title){

        setEmptyDrawable(resId);
        setEmptyMessage(text,title);
        showEmpty();
    }
    ...
    private void changeEmptyType() {
        ...
        if (!mViewsAdded) {
            ...
            mEmptyRelativeLayout.setGravity(Gravity.CENTER_HORIZONTAL);
    ...
    private void refreshMessages() {
        ...
        if (mEmptyMessageViewId>0 && mEmptyMessage!=null&&mEmptyTitle!=null&&mEmptyTitleViewId>0) {
            mEmptyTtileView = (TextView) mEmptyView.findViewById(mEmptyTitleViewId);
            mEmptyMessageView = ((TextView)mEmptyView.findViewById(mEmptyMessageViewId));
            mEmptyMessageView.setText(mEmptyMessage);
            mEmptyTtileView.setText(mEmptyTitle);
...
//            setTopDrawables(mLoadingMessageView,mLoadingDrawable);// loading 不能已经有loading image view ，不能直接设置TopDrawable
    ...
    private void setDefaultValues() {
        if (mEmptyView==null) {
            ...
            if (!(mEmptyTitleViewId>0)) mEmptyTitleViewId = R.id.textViewTitle;
