package com.wowo.wowo.Views.TimeSelector;
...
import com.wowo.wowo.Views.TimeSelector.Utils.DateUtil;
import com.wowo.wowo.Views.TimeSelector.Utils.ScreenUtil;
import com.wowo.wowo.Views.TimeSelector.Utils.TextUtil;
import com.wowo.wowo.Views.TimeSelector.view.PickerView;
...
public class TimeSelector {
    ...
    public void show(final String tvDate) {
        ...
        curCalendar.setTime(DateUtil.parse(tvDate, FORMAT_STR));
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                handler.handle(DateUtil.format(selectedCalender.getTime(), DateUtil.DEFAULT_TEMPLATE));
